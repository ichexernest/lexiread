const mock={
    newsContent: `Distance runner Ben Connor says he has declined to race for Great Britain at the European Road Running Championships after being asked to pay to compete.
