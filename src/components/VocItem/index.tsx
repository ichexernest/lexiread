...
export default function VocItem({item, handleClick}: VocItemProps) {
  return (
  <div onClick={handleClick} className="flex items-center justify-between py-3 w-full border-b border-primary-hover gap-2 px-3 hover:bg-primary-hover cursor-pointer">
